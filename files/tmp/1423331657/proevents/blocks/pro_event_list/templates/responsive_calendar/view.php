...
$ajax_url = Loader::helper('concrete/urls')->getToolsURL('ajax_cal_responsive.php','proevents').'?title='.$title.$state.'&bID='.$bID;
...
if($showfeed==1){		
	?>
		<div class="backlink" style="float: right; font-size: 9px; margin-top: 22px;">
				<?php   echo t('built with ')?><a href="http://goradiantweb.com" alt="RadiantWeb concrete5 addon packages blocks" title="goradiantweb.com Concrete5 Addons">RadiantWeb.com</a><?php   echo t(' products.')?>
		</div>
	   	<div class="iCal">
