...
$ajax_url = Loader::helper('concrete/urls')->getToolsURL('dynamic_ajax.php','proevents').'?title='.$title.'&sctID='.$sctID.'&ctID='.$ctID.'&cID='.$c->cID.'&bID='.$bID.$state;
?>
...
<div id="dynamic_contain">
	<div id="dynamic_header">
		...
		<div id="month_title" alt="<?php  echo date('m')?>"><?php  echo strtoupper($months[date('M')])?><?php  echo date(' Y')?></div>
