...
class ProeventsPackage extends Package {
	...
	public function upgrade(){
		...
		*/
		...
		if( !is_object($event_price) ) {
	  	...
	  	////////////////////////////////////////////////////////////////////////////
		//because goolgle shut down v2 googleCalAPI
		///////////////////////////////////////////////////////////////////////////
	  	$args = array(
			'showHolidays'=> false,
		);
		...
		$q = ("INSERT INTO btProEventSettings (showHolidays) VALUES (?)");
		$db->EXECUTE($q,$args);
  ...
  public function on_start(){
    ...
    Events::extend('proforms_item_entry', 'ProeventsFormStatusExtend', 'onSubmit', DIRNAME_PACKAGES . '/' . $this->pkgHandle . '/models/events/proforms_extend.php');
