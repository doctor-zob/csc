...
extract($settings);	
	...
	if ($c->isEditMode()) { 
		echo '<i style="color: orange;max-width: 400px;display: block;">'.t('Don\'t forget, you can quickly change this to Calendar view by clicking on this area, and selecting "Custom Template".<br/><br/>').'</i>';
	}
					...
					<div class="smallcal <?php  echo $i?>">
						...
						<div class="infowrap">
							...
							<div class="details_container" style="display: none;">
								...
								<?php   if($address){ ?>
								<div class="local">
									<img src="http://maps.googleapis.com/maps/api/staticmap?center=&zoom=9&size=1100x300&maptype=roadmap&markers=color:blue%7Clabel:S%7C<?php  echo $address?>&sensor=false" alt="image_map" class="location_map_image"/> <br />
